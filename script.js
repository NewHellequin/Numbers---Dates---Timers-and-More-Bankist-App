...
// console.log(new Date(2037, 10, 18, 15, 23, 5));
// console.log(new Date(2037, 10, 31, 15, 23, 5));

// console.log(new Date(0));
// console.log(new Date(3 * 24 * 60 * 60 * 1000)); // way to convert miliseconds to days
...
// date library like moment.js - free library for devs
...
//   (ing1, ing2) => console.log(`Here is your pizza witn ${ing1} and ${ing2} 🍕`),
//   3000,
//   ...ingredients
// );
// console.log('Waiting....');
